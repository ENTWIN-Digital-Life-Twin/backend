...
import com.digitallifetwin.wellness.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({
            SleepRecordNotFoundException.class,
            WaterRecordNotFoundException.class,
            MealNotFoundException.class,
            WorkoutNotFoundException.class,
            MoodRecordNotFoundException.class,
            HealthRecordNotFoundException.class,
            WellnessGoalNotFoundException.class
    })
    ...
    @ExceptionHandler({
            InvalidGoalTransitionException.class,
